...
- [x] Create README.md with installation (including httpjail and Secretless Broker prerequisites), configuration (.egressor.yml reference), usage guide
- [x] Create CLAUDE.md with project conventions, architecture overview, key file paths
- [x] Create example .egressor.yml files for common setups
- [x] Document httpjail rule format and how .egressor.yml maps to httpjail JS rules
- [x] Document Secretless Broker setup and how .egressor.yml secrets map to secretless.yml services
